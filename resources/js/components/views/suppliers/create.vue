<template>
   <div>
   <div class="">
   <router-link to="/employees" class="btn btn-primary"> All Suppliers</router-link>
   </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="login-form">
                  ...
                  <form class="user" @submit.prevent="supplierStore" enctype="multipart/form-data">
                  <div class="form-row">
                   ...
                   <div class="form-group">
                      ...
                      <input type="text" class="form-control" v-model="form.shop_name" id="exampleInputLastName" placeholder="Enter Your Shop Name">
                      <div class="errors" v-if="errors.shop_name">
                        <small class="text-danger" :key="error" v-for="error in errors.shop_name"> {{ error }} </small>
                      </div>
                    </div>
                   </div>
