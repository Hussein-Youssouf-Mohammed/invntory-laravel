<!-- TopBar -->
<nav id="navbar" style="display: none" v-show="$route.path === '/login' || $route.path === '/register' || $route.path === '/forget' ? false : true" class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top">
